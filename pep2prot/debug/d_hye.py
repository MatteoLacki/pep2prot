...
from pep2prot.graphs import ProtPepGraph, get_full_prot_pep_graph
...
G, lonely_peps, lonely_prots, prots_no_peps, peps_no_prots = get_full_prot_pep_graph(DD.index, DD.prots)
